import { Currency, CurrencyAmount, currencyEquals, CBTT, Token, ChainId } from '@hotcrosscom/quackswap-sdk'
...
function currencyKey(currency: Currency, chainId: ChainId): string {
  return currency instanceof Token ? currency.address : currency === CBTT[chainId] ? 'BTT' : ''
}
...
export default function CurrencyList({
  ...
  const itemData = useMemo(() => (showETH ? [CBTT[chainId], ...currencies] : currencies), [
    currencies,
    showETH,
    chainId
  ])
