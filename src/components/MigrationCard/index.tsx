...
import { Pair, Fraction } from '@hotcrosscom/quackswap-sdk'
import { Panel, OptionButton, OptionsWrapper, Divider, MigrateButton, InnerWrapper } from './styleds'
import Stat from '../Stat'
import { Text, Box, DoubleCurrencyLogo } from '@hotcrosscom/quackswap-components'
      ...
      <InnerWrapper>
        <Box>
          <Stat
            ...
            stat={`${totalLiqAmount ? totalLiqAmount.toSignificant(6) : '-'} QSL`}
