...
import { Text, Box, DoubleCurrencyLogo, Steps, Step } from '@hotcrosscom/quackswap-components'
import { Pair, TokenAmount, JSBI } from '@hotcrosscom/quackswap-sdk'
...
const PoolInfo = ({
  ...
  const yourPngRate = {
    ...
    value: `${pngRate}    ${t('earnPage.rewardPerWeek', { symbol: 'QUACK' })}`
  }
