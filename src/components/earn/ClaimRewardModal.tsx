      ...
      await stakingContract[method](...args)
        .then((response: TransactionResponse) => {
          addTransaction(response, {
            summary: t('earn.claimAccumulated', { symbol: 'QUACK' })
          })
        ...
        <ContentWrapper gap="lg">
          ...
          {stakingInfo?.earnedAmount && (
            <AutoColumn justify="center" gap="md">
              ...
              <TYPE.body>{t('earn.unclaimedReward', { symbol: 'QUACK' })}</TYPE.body>
            </AutoColumn>
          )}
          {isSuperFarm &&
          ...
          >
            {errorMessage ? errorMessage : isSuperFarm ? t('earn.claim') : t('earn.claimReward', { symbol: 'QUACK' })}
          </ButtonError>
        </ContentWrapper>
      )}
      {attempting && !hash && (
