import { TokenAmount, JSBI, ChainId, CHAINS } from '@quackswap/sdk'
import React, { useMemo, useState } from 'react'
import { X } from 'react-feather'
import styled from 'styled-components'
import tokenLogo from '../../assets/images/logo.png'
import { injected } from '@quackswap/components'
                  ...
                  <TYPE.white color="white">
                    ...
                    {quackToClaim && quackToClaim.greaterThan('0') && (
                      <StyledInternalLink
                        ...
                        to={`/quack/${DOUBLE_SIDE_STAKING_REWARDS_CURRENT_VERSION}`}
                      >
                        ({t('earn.claim')})
                      </StyledInternalLink>
                    )}
