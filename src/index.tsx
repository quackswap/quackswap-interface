...
import { NetworkContextName, QuackSwapProvider } from '@hotcrosscom/quackswap-components'
...
const ComponentThemeProvider = () => {
  ...
  return (
    <QuackSwapProvider library={library} chainId={chainId} account={account ?? undefined} theme={theme as any}>
