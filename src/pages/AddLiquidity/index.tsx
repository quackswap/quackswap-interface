...
import { Currency, currencyEquals, CBTT, TokenAmount, WBTT } from '@hotcrosscom/quackswap-sdk'
...
export default function AddLiquidity({
  ...
  const oneCurrencyIsWBTT = Boolean(
    chainId &&
      ((currencyA && currencyEquals(currencyA, WBTT[chainId])) ||
        (currencyB && currencyEquals(currencyB, WBTT[chainId])))
  )
  ...
  async function onAdd() {
    try {
      ...
      if (currencyA === CBTT[chainId] || currencyB === CBTT[chainId]) {
        const tokenBIsETH = currencyB === CBTT[chainId]
        estimate = router.estimateGas.addLiquidityBTT
        method = router.addLiquidityBTT
        args = [
  ...
  const handleCurrencyBSelect = useCallback(
    (_currencyB: Currency) => {
      ...
      if (currencyIdA === newCurrencyIdB) {
        ...
        history.push(`/add/${currencyIdA ? currencyIdA : 'BTT'}/${newCurrencyIdB}`)
      }
    },
