...
import { Currency, currencyEquals, CBTT, Percent, WBTT } from '@hotcrosscom/quackswap-sdk'
...
export default function RemoveLiquidity({
  ...
  async function onRemove() {
    ...
    const currencyBIsETH = currencyB === CBTT[chainId]
    const oneCurrencyIsETH = currencyA === CBTT[chainId] || currencyBIsETH
  ...
  const oneCurrencyIsBTT = currencyA === CBTT[chainId] || currencyB === CBTT[chainId]
    ...
    <>
                  ...
                  <AutoColumn gap="10px">
                    ...
                    {chainId && (oneCurrencyIsWBTT || oneCurrencyIsBTT) ? (
                      <RowBetween style={{ justifyContent: 'flex-end' }}>
                        {oneCurrencyIsBTT ? (
                          <StyledInternalLink
                            to={`/remove/${currencyA === CBTT[chainId] ? WBTT[chainId].address : currencyIdA}/${
                              currencyB === CBTT[chainId] ? WBTT[chainId].address : currencyIdB
                            }`}
                          >
      ...
      {pair ? (
        <AutoColumn style={{ minWidth: '20rem', width: '100%', maxWidth: '400px', marginTop: '1rem' }}>
          <MinimalPositionCard showUnwrapped={oneCurrencyIsWBTT} pair={pair} />
        </AutoColumn>
      ) : null}
    </>
  )
