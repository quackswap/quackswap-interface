...
import { NewsWidget, WatchList, Portifolio } from '@hotcrosscom/quackswap-components'
import { ChainId, CHAINS } from '@hotcrosscom/quackswap-sdk'
...
const Dashboard = () => {
  ...
  const { chainId = ChainId.BITTORRENT_MAINNET } = useActiveWeb3React()
  return (
    <PageWrapper>
