...
import { JSBI, Currency, TokenAmount } from '@hotcrosscom/quackswap-sdk'
  ...
  return (
    <StyledBottomCard dim={stakedAmount?.equalTo(BIG_INT_ZERO)} isOverlay={isOverlay}>
      ...
      <AutoColumn gap="sm">
        <RowBetween>
          <div>
            <TYPE.black>{t('earnPage.unclaimedReward', { symbol: currency ? currency?.symbol : 'QUACK' })}</TYPE.black>
          </div>
        ...
        <RowBetween style={{ alignItems: 'baseline' }}>
          ...
          <TYPE.black fontSize={16} fontWeight={500}>
            ...
            {t('earnPage.rewardPerWeek', { symbol: currency ? currency?.symbol : 'QUACK' })}
          </TYPE.black>
        </RowBetween>
      </AutoColumn>
    </StyledBottomCard>
