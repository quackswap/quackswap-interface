...
import { Token, Currency, TokenAmount } from '@hotcrosscom/quackswap-sdk'
    ...
    <PageWrapper gap="lg" justify="center">
        ...
        <PoolData>
          <AutoColumn gap="sm">
            ...
            <TYPE.body fontSize={isSuperFarm ? 18 : 24} fontWeight={500}>
              ...
              {t('earnPage.rewardPerWeek', { symbol: 'QUACK' })}
            </TYPE.body>
      ...
      <PositionInfo gap="lg" justify="center" dim={showAddLiquidityButton}>
            ...
            <CardSection>
              ...
              <AutoColumn gap="md">
                ...
                <RowBetween style={{ alignItems: 'baseline' }}>
                  ...
                  <TYPE.white>
                    QSL {currencyA?.symbol}-{currencyB?.symbol}
                  </TYPE.white>
                </RowBetween>
              </AutoColumn>
            </CardSection>
        ...
        {!showAddLiquidityButton && (
          <DataRow style={{ marginBottom: '1rem' }}>
            <ButtonPrimary padding="8px" borderRadius="8px" width="160px" onClick={handleDepositClick}>
              {stakingInfo?.stakedAmount?.greaterThan(BIG_INT_ZERO)
                ? t('earnPage.deposit')
                : t('earnPage.depositStakingTokens', { symbol: 'QSL' })}
            </ButtonPrimary>
        ...
        {!userLiquidityUnstaked || userLiquidityUnstaked.equalTo('0') ? null : (
          <TYPE.main>
            {userLiquidityUnstaked.toSignificant(6)} {t('earnPage.stakingTokensAvailable', { symbol: 'QSL' })}
          </TYPE.main>
        )}
      </PositionInfo>
    </PageWrapper>
