...
import { JSBI, TokenAmount, ChainId } from '@hotcrosscom/quackswap-sdk'
...
export default function Vote() {
  ...
  const pngBalance: TokenAmount | undefined = useTokenBalance(account ?? undefined, chainId ? QUACK[chainId] : undefined)
          ...
          <RowBetween>
            ...
            {userDelegatee && userDelegatee !== ZERO_ADDRESS ? (
              <RowFixed>
                ...
                <AddressButton>
                  <StyledExternalLink
                    href={getEtherscanLink(ChainId.BITTORRENT_MAINNET, userDelegatee, 'address')}
                    style={{ margin: '0 4px' }}
                  >
