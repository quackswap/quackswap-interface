    ...
    (field: Field, currency: Currency) => {
      dispatch(
        selectCurrency({
          field,
          currencyId:
            currency instanceof Token ? currency.address : chainId && currency === CBTT[chainId] ? 'BTT' : ''
        })
      )
    },
    [chainId, dispatch]
...
const BAD_RECIPIENT_ADDRESSES: string[] = [
  FACTORY_ADDRESS[ChainId.BITTORRENT_MAINNET], // v2 factory
  ROUTER_ADDRESS[ChainId.BITTORRENT_MAINNET] // v2 router 02
]
