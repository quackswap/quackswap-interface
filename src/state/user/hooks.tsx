import { ChainId, Pair, Token } from '@hotcrosscom/quackswap-sdk'
...
export function toV2LiquidityToken([tokenA, tokenB]: [Token, Token], chainId: ChainId): Token {
  return new Token(tokenA.chainId, Pair.getAddress(tokenA, tokenB, chainId), 18, 'QSL', 'Quack Swap Liquidity')
}
