...
export const SINGLE_SIDE_STAKING: { [key: string]: SingleSideStaking } = {
  WBTT_V0: {
    rewardToken: WBTT[ChainId.BITTORRENT_MAINNET],
    conversionRouteHops: [],
    stakingRewardAddress: '0xD49B406A7A29D64e081164F6C3353C599A2EeAE9',
    version: 0
  },
  OOE_V0: {
    rewardToken: OOE[ChainId.BITTORRENT_MAINNET],
    conversionRouteHops: [WBTT[ChainId.BITTORRENT_MAINNET]],
    stakingRewardAddress: '0xf0eFf017644680B9878429137ccb2c041b4Fb701',
    version: 0
  },
  APEIN_V0: {
    rewardToken: APEIN[ChainId.BITTORRENT_MAINNET],
    conversionRouteHops: [WBTT[ChainId.BITTORRENT_MAINNET]],
    stakingRewardAddress: '0xfe1d712363f2B1971818DBA935eEC13Ddea474cc',
    version: 0
  },
  ORBS_V0: {
    rewardToken: ORBS[ChainId.BITTORRENT_MAINNET],
    conversionRouteHops: [WBTT[ChainId.BITTORRENT_MAINNET]],
    stakingRewardAddress: '0x78d4BFb3b50E5895932073DC5Eb4713eb532941B',
    version: 0
  },
  PNG_V0: {
    rewardToken: QUACK[ChainId.BITTORRENT_MAINNET],
    conversionRouteHops: [WBTT[ChainId.BITTORRENT_MAINNET]],
...
export const SINGLE_SIDE_STAKING_REWARDS_INFO: {
  ...
  [ChainId.BITTORRENT_MAINNET]: [SINGLE_SIDE_STAKING_V0]
}
