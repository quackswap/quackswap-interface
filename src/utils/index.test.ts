...
import { TokenAmount, Token, ChainId, Percent, JSBI } from '@hotcrosscom/quackswap-sdk'
...
describe('utils', () => {
  describe('#getEtherscanLink', () => {
    it('correct for tx', () => {
      expect(getEtherscanLink(ChainId.BITTORRENT_MAINNET, 'abc', 'transaction')).toEqual('https://snowtrace.io/tx/abc')
    })
    it('correct for token', () => {
      expect(getEtherscanLink(ChainId.BITTORRENT_MAINNET, 'abc', 'token')).toEqual('https://snowtrace.io/token/abc')
    })
    it('correct for address', () => {
      expect(getEtherscanLink(ChainId.BITTORRENT_MAINNET, 'abc', 'address')).toEqual('https://snowtrace.io/address/abc')
    })
